<?php
    ...
    if (isset($_GET['delete_id']) && !empty($_GET['delete_id'])) {
        ...
        $bdd->query("DELETE FROM t_statut_commande_trad WHERE fk_statut_commande=".$id_statut);
    ...
    $sql.= '    s.isDefault AS isDefault, ';
    $sql.= '    s.isStock AS isStock, ';
    $sql.= '    s.isBlock AS isBlock ';
    ...
    $html .= '                  <td class="tab_td">Par Défaut</td>';
    $html .= '                  <td class="tab_td">Decre. Stock</td>';
    $html .= '                  <td class="tab_td">Bloquant</td>';
